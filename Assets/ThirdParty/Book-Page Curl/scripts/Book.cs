...
// The Cartoon Kapoen team made some changes made to the original script for it to fit our use case better, many thanks to the original creator!
...
public class Book : MonoBehaviour
{
    ...
    public UnityEvent<int> OnFlipStart;
    ...
    public void ForceUpdateTextures(int dir)
    {
        UpdateSprites();
    }
    ...
    public void DragRightPageToPoint(Vector3 point)
    {
        ...
        Left.texture = (currentPage < bookPages.Length) ? bookPages[currentPage] : background;
        Left.transform.SetAsFirstSibling();
        
        Right.gameObject.SetActive(true);
        Right.transform.position = RightNext.transform.position;
        Right.transform.eulerAngles = new Vector3(0, 0, 0);
        Right.texture = (currentPage < bookPages.Length - 1) ? bookPages[currentPage + 1] : background;

        RightNext.texture = (currentPage < bookPages.Length - 2) ? bookPages[currentPage + 2] : background;
    ...
    public void DragLeftPageToPoint(Vector3 point)
    {
        ...
        Left.transform.eulerAngles = new Vector3(0, 0, 0);
        Left.texture = (currentPage >= 2) ? bookPages[currentPage - 2] : background;

        LeftNext.texture = (currentPage >= 3) ? bookPages[currentPage - 3] : background;
    ...
    void UpdateSprites()
    {
        LeftNext.texture= (currentPage > 0 && currentPage <= bookPages.Length) ? bookPages[currentPage-1] : background;
        RightNext.texture=(currentPage>=0 &&currentPage<bookPages.Length) ? bookPages[currentPage] : background;
    }
